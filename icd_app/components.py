...
STATUS_VARIANTS = {
    ...
    "In Review": "neutral", "Pending": "neutral", "Archived": "neutral",
}
...
def stat_card_html(icon, label, value, sub=None) -> str:
    """Returns the HTML for one Home-page stat card. Centralizes the markup
    that was previously written inline in a loop in app.py."""
